...
const logos = [
  { name: 'TypeScript', svg: <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 24 24"><path fill="#3178c6" d="M0 0h24v24H0z"/><path fill="#fff" d="M9.13 18.39h5.73v-1.52H11.4v-4.06h3.18v-1.52H11.4V8h3.42V6.51H9.13v11.88zM15.4 18.39h5.5v-1.52h-2.73v-2.03h2.46v-1.51h-2.46v-2.05h2.73V9.77h-5.5v8.62z"/></svg> },
  ...
  { name: 'Next.js', svg: <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 128 128"><path fill="#000" d="M64 128c35.346 0 64-28.654 64-64S99.346 0 64 0 0 28.654 0 64s28.654 64 64 64Z"/><path fill="#fff" d="M97.26 38.255h-9.923v38.995c-1.42 5.034-7.854 8.01-12.023 5.922l-21.61-10.88v11.134h-9.28V38.254h9.923v38.42l23.5-11.83V38.255Z"/></svg> },
  { name: 'Node.js', svg: <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 24 24"><path fill="#8CC84B" d="M22.2,11.3c-0.2-0.8-0.6-1.5-1.1-2.1c-0.1-0.2-0.3-0.3-0.5-0.4c-0.8-0.7-1.8-1-2.8-1.2l-0.5-0.1c-0.2,0-0.4-0.1-0.6-0.1h-4V6.9c0-0.3-0.3-0.6-0.6-0.6s-0.6,0.3-0.6,0.6v1.1c-2.4,0.1-4.2,0.8-5.3,2.2C5,11.3,4.7,12.4,5.1,13.4c0.2,0.6,0.6,1.2,1.1,1.6c0.6,0.4,1.2,0.7,1.9,0.9l0.5,0.1c0.2,0.1,0.5,0.1,0.7,0.2c0.7,0.2,1.3,0.5,1.7,1c0.5,0.5,0.8,1.2,0.6,2c-0.2,0.8-0.6,1.5-1.2,2c-0.6,0.5-1.4,0.8-2.2,0.9l-0.5,0.1c-0.2,0-0.4,0.1-0.6,0.1h-4v0.9c0,0.3-0.3,0.6-0.6,0.6s-0.6-0.3-0.6-0.6v-1c2.4-0.1,4.2-0.8,5.3-2.2c1.1-1.4,1.4-2.8,1-4.2c-0.2-0.7-0.5-1.3-1-1.8c-0.6-0.5-1.2-0.8-1.9-1l-0.5-0.1c-0.2,0-0.5-0.1-0.7-0.2c-0.7-0.2-1.3-0.5-1.7-1c-0.5-0.5-0.8-1.2-0.6-2c0.4-1.6,2-2.8,4.5-3.1V7.5h3.4v0.9c2,0.2,3.5,0.8,4.5,2.1c1.1,1.4,1.4,2.8,1,4.2c-0.1,0.3-0.2,0.5-0.3,0.8C22.4,11.7,22.3,11.5,22.2,11.3z"/></svg> },
  { name: 'Tailwind CSS', svg: <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 32 32"><path fill="#38bdf8" d="M16 0C7.163 0 0 7.163 0 16s7.163 16 16 16 16-7.163 16-16S24.837 0 16 0zm0 3.297c2.316 0 4.502.733 6.355 2.05 1.853 1.317 3.321 3.129 4.238 5.253-1.854-1.722-4.148-2.78-6.6-2.78-5.44 0-9.849 4.409-9.849 9.848s4.409 9.848 9.85 9.848c2.451 0 4.745-1.058 6.599-2.78-1.03 2.124-2.5 3.936-4.353 5.253C20.502 31.267 18.316 32 16 32c-2.316 0-4.502-.733-6.355-2.05S6.324 26.82 5.407 24.696c1.854 1.722 4.148 2.78 6.6 2.78 5.44 0 9.849-4.409 9.849-9.848s-4.409-9.848-9.85-9.848c-2.451 0-4.745 1.058-6.599 2.78C6.331 8.412 7.799 6.6 9.652 5.283S13.837 3.297 16 3.297z"/></svg> },
